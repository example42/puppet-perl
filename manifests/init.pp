...
class perl (
  ...
  $modules              = params_lookup( 'modules' ),
  $cpan_modules         = params_lookup( 'cpan_modules' )
  ...
  if $modules != {} {
    ...
    create_resources('perl::module', $modules)
  }

  if $cpan_modules != {} {
    validate_hash($cpan_modules)
    create_resources('perl::cpan::module', $cpan_modules)
  }
